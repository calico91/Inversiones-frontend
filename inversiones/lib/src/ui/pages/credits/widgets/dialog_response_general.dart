...
class DialogResponseGeneral extends StatelessWidget {
  DialogResponseGeneral({required this.data});
  final PayFee data;
            ...
            child: SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  _mostrarContenido(
                    'Valor interes:',
                    General.formatoMoneda(data.valorInteres),
                    context,
                  ),
                  _mostrarContenido(
                    'Valor cuota:',
                    General.formatoMoneda(data.valorCuota),
                    context,
                  ),
                ],
              ),
